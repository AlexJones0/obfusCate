...
class CountUnit(CodeMetricUnit):
    ...
    positions = dict([(x, i) for (i, x) in enumerate([
        "File Size", "Lines", "Tokens", "Characters", "Functions", 
        "Statements", "Stmts/Function", "AST Nodes", "Constants", 
    ...
    def add_lexer_metrics(self, old_source: CSource, new_source: CSource) -> None:
        ...
        self.add_metric("File Size", file_size(new_size, signed=False), file_size(new_size - old_size))
...
class CFGGenerator(NodeVisitor):
    ...
    def __visit_If(self, node):
        pass #TODO: record nodes/edges
    
    def __visit_switch(self, node):
        pass #TODO: record nodes/edges
    
    def __visit_While(self, node):
        pass #TODO: record nodes/edges
    
    def __visit_DoWhile(self, node):
        pass #TODO: record nodes/edges    
    
    def __visit_for(self, node):
        pass #TODO: record nodes/edges
    
    def __visit_Continue(self, node):
        pass #TODO: record nodes/edges
    
    def __visit_Break(self, node):
        pass #TODO: record nodes/edges
    
    def __visit_Label(self, node):
        pass #TODO: record labels (per function)
    
    def __visit_Goto(self, node):
        pass # TODO: record nodes/edges
    
    def __visit_FuncDef(self, node):
        pass # TODO: record function definitions
    
    def __visit_FuncCall(self, node):
        pass # TODO: link with definition nodes
...
class CyclomatricComplexityUnit(CodeMetricUnit):
    ...
    positions = dict([(x, i) for (i, x) in enumerate([
        "Cyclomatic Number (M)", "Interpretation", 
...
class CognitiveComplexityUnit(CodeMetricUnit):
    ...
    positions = dict([(x, i) for (i, x) in enumerate([
        "Avg. Cognitive Number", "Max Cognitive Number", "Cognitive Variance",
        "Max Nesting Depth", "Avg. Nesting Depth", "Nesting Variance"
    ])])
